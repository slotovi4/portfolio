...
function toggleMenu() {
  if (!showMenu) {
    ...
    menuBranding.classList.add("menu-branding_close");

    menuBtnLine.forEach(item => item.classList.add("menu-btn__line_close"));
    navItems.forEach(item => item.classList.add("menu-nav-item_show"));
    ...
    menuBranding.classList.remove("menu-branding_close");

    menuBtnLine.forEach(item => item.classList.remove("menu-btn__line_close"));
    navItems.forEach(item => item.classList.remove("menu-nav-item_show"));
